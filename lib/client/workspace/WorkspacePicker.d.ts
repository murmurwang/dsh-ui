...
export interface WorkspacePickFlowProps {
    ...
    /** 直接目录选择源（原生 picker API；dsh-ui 照搬版不用目录流洞）。 */
 ...
 */
export declare function WorkspacePickFlow({ t, open, anchorRef, useWorkspaces, createWorkspace, pickPath, onPick, onClose, addOnly, side, selectedId, }: WorkspacePickFlowProps): import("react").JSX.Element;
/**
