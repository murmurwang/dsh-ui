...
export declare function isInsideChatArea(node: Node | null): boolean;
/**
 ...
 */
export declare function readSelection(excluded: Element | null, allowed?: (node: Node | null) => boolean): SelectionSnapshot | null;
/**
 ...
 * @returns 取消监听函数。
 */
export declare function watchSelection(handler: (snapshot: SelectionSnapshot | null) => void, excluded: () => Element | null, allowed?: (node: Node | null) => boolean): () => void;
